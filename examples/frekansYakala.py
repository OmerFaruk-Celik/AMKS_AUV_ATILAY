...
def update_frame(frame):
    ...
    if lowcut < frekans_peak < highcut:
        ...
        # Beş dalga boyu kadar veriyi al
        single_wave = filtered_data[:5 * wave_length]
        
        # X eksenini güncelle
        line.set_xdata(np.arange(5 * wave_length) / RATE)
        ...
        line.set_ydata(np.zeros(5 * wave_length))  # Grafiğe sıfır veri gönder
