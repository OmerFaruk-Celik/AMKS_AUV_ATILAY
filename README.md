...
Jupyter Notebook dosyasının içeriği:
...
Python Dosyaları
sim.py Dosyasının İçeriği:
Python

# sim.py içeriği burada olacak
# Örneğin:
def sim_function():
    print("This is a simulation function.")

sim3D2.py Dosyasının İçeriği:
Python

# sim3D2.py içeriği burada olacak
# Örneğin:
def sim3D2_function():
    print("This is a 3D simulation function.")

sim3D.py Dosyasının İçeriği:
Python
...
Bu Python dosyası, 3D simülasyon animasyonunu içermektedir.
Code

Bu `README.md` dosyası, resimleri doğrudan sayfada görüntüler ve diğer dosyaların içeriklerini de doğrudan sayfada gösterir. Dosya içeriklerini manuel olarak kopyaladım. Bu şekilde, `README.md` dosyasını GitHub deposuna eklediğinizde, belirttiğiniz dosyaların içerikleri doğrudan görüntülenecektir.
